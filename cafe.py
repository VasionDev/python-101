...
checkbox4 = Checkbutton(frame1TopLeft, font=('arial', 15, 'bold'), text='CheckBox 4', variable=check1, onvalue=1, offvalue=0)
checkbox4.grid(row=3, column=0, sticky=W)
checkbox5 = Checkbutton(frame1TopLeft, font=('arial', 15, 'bold'), text='CheckBox 5', variable=check2, onvalue=1, offvalue=0)
checkbox5.grid(row=4, column=0, sticky=W)
checkbox6 = Checkbutton(frame1TopLeft, font=('arial', 15, 'bold'), text='CheckBox 6', variable=check3, onvalue=1, offvalue=0)
checkbox6.grid(row=5, column=0, sticky=W)
checkbox7 = Checkbutton(frame1TopLeft, font=('arial', 15, 'bold'), text='CheckBox 7', variable=check1, onvalue=1, offvalue=0)
checkbox7.grid(row=6, column=0, sticky=W)
checkbox8 = Checkbutton(frame1TopLeft, font=('arial', 15, 'bold'), text='CheckBox 8', variable=check2, onvalue=1, offvalue=0)
